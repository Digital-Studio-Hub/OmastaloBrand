...
const WID = process.env.LEKKER_WORKSPACE_ID || "246d4cf9-e639-41ee-81bf-e2fd4354d153";
const TOKEN = process.env.LEKKER_TOKEN || "c4122b1d-89df-469f-a5ac-eb45f56cd452";
